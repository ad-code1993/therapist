  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Verified Therapists</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{sampleTherapists.filter(t => t.verification === "verified").length}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">{resolvedComplaints.length}</div>
          </CardContent>
        </Card>
      </div>
              ...
              <tbody>
                {verifications.map((therapist) => (
                  <tr key={therapist.therapist_id} className="border-b last:border-0 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600">${therapist.hourly_rate}/hr</td>
